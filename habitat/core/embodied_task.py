...
class EmbodiedTask:
    ...
    def step(self, action: Union[int, Dict[str, Any]], episode: Type[Episode], **kwargs):
        if "action_args" not in kwargs or kwargs["action_args"] is None:
            action["action_args"] = {}
        else:
            action["action_args"] = kwargs["action_args"]
